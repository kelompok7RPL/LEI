<?php
   ...
   if (isset($_GET['id'] ))
   {
   	$jenispraktikum=$_GET['id'];
   	$sql="select matakuliah.matakuliah_nama from matakuliah where matakuliah_id=$jenispraktikum";
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<ul class="breadcrumb">
					...
					<li>
					<i class="icon-plus"></i>
					<a href="#">Tambah Jadwal</a></li>
				</ul>

				<b><center> Input Kelompok matakuliah <?php echo $matakuliah_nama?> </b><br><br>
				 <center>         
		            <form action='tambahjadwal1.php'  method='POST' >
		               <table>
		                  <tr>
		                    <td> Nama kelompok </td>
		                    <td><input type="text" name="jadwal_nama"  required  ></td>
		                  </tr>
		                  <tr>
		                    <td> Hari </td>
							<td><select name="jadwal_hari" >
							<option value="Senin"> Senin</option>
							<option value="Selasa"> Selasa</option>
							<option value="Rabu"> Rabu</option>
							<option value="Kamis"> Kamis</option>
							<option value="Jum'at"> Jum'at</option></select>
							</td>
		                  </tr>
		                  <tr>
		                    <td> Jam</td>
		                    <td><input type="text" name="jadwal_jam"   required ></td>
		                  </tr>
						  <tr>
							<td><input type="submit" name='submit' value="Input" class="btn btn-success"></td>
						  </tr>
		                  <input type="hidden" name="matakuliah_id"  value='<?php echo $jenispraktikum?>' required >	                  
		            </table>  
