      ...
      <form id="formku">
        <table align="center">
          <tr>
            ...
            <tr>
                    <td> Tahun</td>
                    <td><input type="text" name="tahun" size="48" placeholder="Tahun"></td>
            </tr>
            <tr>
                    <td> Kelompok</td>
                    <td><input type="text" name="kelompok" size="48" placeholder="Kelompok"></td>
            </tr>
        </table>
        <a href='lpraktikum1.php'><button type="submit" class="btn btn-info icon-print"> Print</button></a>
      </form>
    </center>
