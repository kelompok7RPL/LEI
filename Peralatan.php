...
<div class="wrapper row3">
  <div class="rounded">
    ...
    <form action="index.php" method="post">
        <br>
        <span class="style3"><h3 align=center >Peralatan</h3></span>
        <table align="center">
        <tr>
        <td align="center"><input type="submit" name="submit" value="Tambah Data"></td>
        <td align="center"><input type="submit" name="submit" value="Lihat Daftar Peralatan"></td>
        </tr>
        </center>
        </table>
