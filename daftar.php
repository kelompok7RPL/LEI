...
{
  echo "kelompok_id indak masuak do wooyy";
}
?>
  ...
  <div class="rounded">
    <main class="container clear"> 
      <!-- main body --> 
        ...
        <center>         
            <form action='daftar1.php' enctype='multipart/form-data'  method='POST' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
               <table>
                  <tr>
                    <td> Username</td>
                  ...
                  <tr>
                    <td> No Handphone </td>
                    <td><input type="telp" name="no_telepon" placeholder="No Handphone" required ></td>
                  </tr>
                  <tr>
                    <td> Masukkan KRS </td>
                    <td> <input type='file' name='namafile' size="30"></td>
                  </tr> 
                  <input type='hidden' name='kelompok_id' value=<?php echo $kelompok_id ?> >
