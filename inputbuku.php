 ...
 if (isset($_GET['id'] ))
{
	...
	$result = mysql_query ('select peralatan.peralatan_id ,peralatan.peralatan_nama,peralatan.jenis_peralatan_id,peralatan.Baik,peralatan.Rusak_ringan,peralatan.Rusak_berat,peralatan.total,peralatan.Catatan from peralatan where peralatan.jenis_peralatan_id=4 ');
	if (! $result)
	{
		echo "query gagal" ;
	}
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<!-- akhir judul -->
				 <a href='tambahbuku.php' ><button type="submit" class="btn btn-success icon-plus"> Tambah Data Buku</button></a><br><br>
				<!-- tabel -->
				<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon book"></i><span class="break"></span>Buku</h2>
						<div class="box-icon">
				...
				<?php
                    while($row = mysql_fetch_assoc($result))
                    {
							...
							echo "<a href='updatebuku.php?id=".$row['peralatan_id']."'><button type='submit' class='btn btn-primary icon-edit'> Update</button></a>";
							?>
							<a onclick="return confirm('Apakah anda yakin?')" href='inputbuku.php?id=<?PHP echo $row['peralatan_id']?>'><button type='submit' class='btn btn-danger icon-trash'> Delete</button></a></td>
							<?PHP
							echo "</tr>";
                    }
                    //echo "</table>";	
