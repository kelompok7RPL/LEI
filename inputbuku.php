	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<!-- akhir judul -->
				 <a href='tambahbuku.php' ><button type="submit" class="btn btn-success">Tambah Data Buku</button></a><br><br>
				<!-- tabel -->
				...
				<?php
                    while($row = mysql_fetch_assoc($result))
                    {
							...
							echo "<a href='updatebuku.php?id=".$row['peralatan_id']."'><button type='submit' class='btn btn-primary'>Update</button></a>";
							?>
							<a onclick="return confirm('Apakah anda yakin?')" href='inputbuku.php?id=<?PHP echo $row['peralatan_id']?>'><button type='submit' class='btn btn-danger'>Hapus</button></a></td>
							<?PHP
							echo "</tr>";
                    }
                    //echo "</table>";	
