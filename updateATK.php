<?php
	...
	if (isset($_POST['peralatan_idd']) )
                    { 		
                            ...
                            if ($masuk )
							{
							header("location:inputATK.php?pesan=1&isi=Berhasil Memperbarui Data");
							}
							else
							{
							header("location:updateATK.php?pesan=1&isi=Gagal Memperbarui Data");
							}                                                      
					} 
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<ul class="breadcrumb">
					...
					<li><a href="inputATK.php">Alat Tulis Kantor</a>
					<i class="icon-angle-right"></i>
					</li>
					
					<li><a href="#">Update Alat Tulis Kantor</a></li>
				</ul>
				...
				<tr>
                    <td> Keterangan</td>
                    <td><input type="text" name="keterangan" size="48" placeholder="Total" value="<?php echo $nilai_update['Catatan']; ?>"></td>
				</tr>
				<tr>
					<td><input type="submit" class="btn btn-warning" name="peralatan_idd" value="Update" class="btn" align="left"></td>
				</tr>
				</table>
