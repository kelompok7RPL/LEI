<?php
	...
	if (isset($_POST['peralatan_idd']) )
                    { 		
							...
							$masuk = mysql_query("UPDATE `peralatan` SET `peralatan_nama`='$nama',`total`='$total',`Catatan`='$keterangan' WHERE `peralatan`.`peralatan_id` = '".$id."'") or die (mysql_error());
							
							
							
                            if ($masuk )
							{
							header("location:inputATK.php?pesan=1&isi");
							}
							else
							{
							header("location:updateATK.php?pesan=1&isi");
							}                                                      
					} 
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<ul class="breadcrumb">
					...
					<a href="inputATK.php">Alat Tulis Kantor</a>
					<i class="icon-angle-right"></i>
					</li>
					
					<li>
					<i class="icon-edit"></i>
					<a href="#">Update Data Alat Tulis Kantor</a></li>
				</ul>

				<!-- judul -->
				<center>
				<H1> Update Data Alat Tulis Kantor</H1>
				</center><br>
				<!-- akhir judul -->
				...
				?>
				<form id="formku" action="updateATK.php" method="POST">
				<table align="center">

				<tr> 
					<td></td>
					<td><input type="hidden" name="id" size="48" value="<?php echo $nilai_update['peralatan_id']; ?>"></td> 
				</tr>
				<tr>
					<td> Nama</td>
					<td><input type="text" name="nama" size="48" value="<?php echo $nilai_update['peralatan_nama']; ?>" required></td> 
				</tr>
				<tr>
					<td> Total</td>
					<td><input type="text" name="total" size="48" value="<?php echo $nilai_update['total']; ?>" required></td> 
				</tr>
				<tr>
                    <td> Keterangan</td>
                    <td><input type="text" name="keterangan" size="48" value="<?php echo $nilai_update['Catatan']; ?>" required></td>
				</tr>
				<tr>
					<td><a href="inputATK.php"><button type="submit" name="peralatan_idd" class="btn btn-warning icon-edit" > Update</button></a></td>
				</tr>
				</table>
