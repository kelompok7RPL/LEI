	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
					...
					<li>
					<i class="icon-user"></i>
					<a href="#">Laporan Peminjaman</a></li>
					
				</ul>
			
			<center>
            <H1> Laporan Peminjaman</H1><br>
            ...
            <table align="center">
              <tr>
                <td> Tahun</td>
                <td><input type="number" name="tahun" size="48" placeholder="Tahun"></td>
             </tr>
			
            </table>
            <a href='lpeminjaman1.php'><button type="submit" class="btn btn-info icon-print"> Print</button></a>  
          </form>
      </center>      
