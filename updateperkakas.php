<?php
	...
	if (isset($_POST['peralatan_idd']) )
                    { 		echo 'bo';
                            ...
                            if ($masuk )
							{
							header("location:inputperkakas.php?pesan=1&isi=Berhasil Memperbarui Data");
							}
							else
							{
							header("location:inputperkakas.php?pesan=1&isi=Gagal Memperbarui Data");
							}                                                      
					} 
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<ul class="breadcrumb">
					...
					<li><a href="inputperkakas.php">Perkakas</a>
					<i class="icon-angle-right"></i>
					</li>
					
					<li><a href="#">Update Perkakas</a></li>
				</ul>
