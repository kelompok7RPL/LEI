<?php
	...
	if (isset($_POST['peralatan_idd']) )
                    { 		echo 'bo';
                            ...
                            if ($masuk )
							{
							header("location:inputperkakas.php?pesan=1&isi");
							}
							else
							{
							header("location:inputperkakas.php?pesan=1&isi");
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<ul class="breadcrumb">
					...
					<a href="inputperkakas.php">Perkakas</a>
					<i class="icon-angle-right"></i>
					</li>
					
					<li>
					<i class="icon-edit"></i>
					<a href="#">Update Data Perkakas</a></li>
				</ul>

				<!-- judul -->
				<center>
				<H1> Update Data Perkakas</H1>
				</center><br>
				<!-- akhir judul -->
				...
				?>
				<form id="formku" action="updateperkakas.php" method="POST">
				<table align="center">
				...
				<tr>
					<td><a href="inputperkakas.php"><button type="submit" name="peralatan_idd" class="btn btn-warning icon-edit" > Update</button></a></td>
				</tr>
				</table>
