<?php
  include ('database.php');
    ...
    $sql = "select Peralatan_nama,total,Catatan from peralatan where jenis_peralatan_id=2";
  ...
  <div id="topbar" class="clear"> 
    ...
    <nav>
      <ul>
        ...
        <li><a href="loginpinjam">Login Peminjam</a></li>
        ...
        <table>    
          ...
          <?php
            while ($row=mysql_fetch_assoc($sql1)) {
              ...
              echo "<td>".$row["total"]."<t/d>";
              echo "<td>".$row["Catatan"]."<t/d>";
               echo "</tr>";             
