	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<!-- akhir judul -->
				 <a href='tambahkomponen.php'><button type="submit" class="btn btn-success icon-plus"> Tambah Data Komponen</button></a><br><br>
				<!-- tabel -->
				<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon cog"></i><span class="break"></span>Komponen</h2>
						<div class="box-icon">
				...
				<?php
                    while($row = mysql_fetch_assoc($result))
                    {
							...
							echo "<a href='updatekomponen.php?id=".$row['peralatan_id']."'><button type='submit' class='btn btn-primary icon-edit'> Update</button></a>";
							?>
							<a onclick="return confirm('Apakah anda yakin?')" href='inputkomponen.php?id=<?PHP echo $row['peralatan_id']?>'><button type='submit' class='btn btn-danger icon-trash'> Delete</button></a></td>
							<?PHP
							echo "</tr>";
                    }
                    //echo "</table>";	
