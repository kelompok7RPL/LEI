...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
            ...
            <br><br>
            <form action='adminkelompok2.php' method='POST'>
              <table align="center">
                <tr>
              ...
              <a href="adminkelompok2.php"><button type="submit" class="btn btn-success icon-hand-right"> Lihat</button></a>
            </form>
          </center>
