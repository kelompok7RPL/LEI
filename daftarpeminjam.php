  ...
  <div class="rounded">
    <main class="container clear"> 
      <!-- main body --> 
         <!-- form --> 
        <center>         
            <form action='daftarpeminjam1.php' enctype='multipart/form-data'  method='POST' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
               <table>
				    <tr>
                    <td> Username </td>
                  ...
                  <tr>
                    <td> No Handphone </td>
                    <td><input type="number" name="no_telepon" placeholder="No Handphone" required ></td>
                  </tr>
