<?php
  include ('database.php');
   ...
   {      
      ...
      $jenis_nilai_id=$_POST['jenisnilai'];
      echo $sql="Select * user.nama, nilai_matakuliah.nilai from nilai_matakuliah, user where jadwal_id='$jadwal_id' and modul_id='$modul_id' and jenis_nilai_id='$jenis_nilai_id'  and nilai_matakuliah.username= user.username";
