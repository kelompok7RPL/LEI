...
?>Selamat Datang <?php echo $username; ?></a></li><?php
       ...
       <ul class="clear">
        ...
        <li><a class="drop" href="#">Inventaris</a>
          <ul>
            ...
            <?PHP if(isset($_SESSION['role_id'])){ if($_SESSION['role_id']=='1'|| $_SESSION['role_id']=='2' )?><li><a href="konfirmasi.php">Konfirmasi Peminjaman</a></li><?php } ?>
          </ul>
        </li>
        <li><a class="drop" href="#">Praktikum</a>
          <ul>
            ...
            <?PHP if(isset($_SESSION['role_id'])){ if($_SESSION['role_id']=='1'|| $_SESSION['role_id']=='2' )?><li><a href="inputnilai.php">Input Nilai</a></li><?php } ?>
          </ul>
        </li>
