...
<?php
  include ('database.php');
   ...
   if (isset($_POST['jenispraktikum'] ))
   {
	...
	$sqla="select matakuliah.matakuliah_nama from matakuliah where matakuliah_id=$jenispraktikum";
   	$sqla1=mysql_query($sqla);
   	$row=mysql_fetch_assoc($sqla1);
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<!-- start: Content -->
				...
				<center>
				<H1> Jadwal Praktikum <?php echo $matakuliah_nama ?></H1>
				</center><br>
				
				<a class="btn btn-success icon-plus" href='tambahjadwal.php?id="<?php echo $jenispraktikum?>"'> Tambah Jadwal </a><br><br>
				
				<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-time"></i><span class="break"></span>Jadwal</h2>
						<div class="box-icon">
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
		          ...
		          <?php
		            while ($row=mysql_fetch_assoc($sql1)) {
		              ...
		              echo "<td style='text-align:center'>".$row["jadwal_hari"]."</td>";
		              echo "<td style='text-align:center'>".$row["jadwal_jam"]."<t/d>";
		              echo "<td style='text-align:center'>";
		              echo "<a class='btn btn-warning icon-edit' href='updatejadwal.php?id=".$row["jadwal_id"]."'> Update</a></td>";
