	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
				<i class="icon-user"></i>
				<a href="aslab.php">Aslab</a>
				<i class="icon-angle-right"></i></li>
				<li>
				<i class="icon-plus"></i>
				<a href="#">Tambah Data Aslab</a></li>
			</ul>

			<!-- form -->
			<center>
				<H1> Tambah Data Aslab</H1>
				</center><br>
				
			 <center>         
	            <form action='tambahaslab.php'  method='POST' >
	               <table>
	                  <tr>
	                    <td> Username</td>
					  ...
					  <tr>
					  <td><a href="aslab.php"><button type="submit" class="btn btn-success icon-plus" align="left"> Input</button></a></td>
					  </tr>
