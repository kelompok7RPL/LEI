      ...
      <ul class="clear">
        ...
        <li><a class="drop" href="#">Inventaris</a>
          <ul>
            ...
            <li><a href="BarangHabisPakai.php">Barang Habis pakai</a></li>
            <li><a href="Buku1.php">Buku</a></li>
            <li><a href="Peminjam.php">Peminjaman</a></li>
            <li><a href="KonfirmasiPeminjaman.php">Konfirmasi Peminjaman</a></li>
          </ul>
        </li>
      ...
      <!-- main body --> 
        <center>
         <table>
            <tr>
              <td>Matakuliah</td> 
              <td><!-- masukkan PHP tampilkan matakuliah--> </td>
            </tr>
            <tr>
              <td>Kelompok</td> 
              <td><!-- masukkan PHP tampilkan kelompok--> </td>
            </tr>
            <tr>
              <td>Modul</td> 
              <td><!-- masukkan PHP tampilkan modul--> </td>
            </tr>
         </table>
          <table>
           <th>
