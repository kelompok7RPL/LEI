	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="#">Update Kalab</a>
				</li>
			</ul>
			
			<center>
				<H1> Update Data Kalab</H1>
			</center><br>
			<!-- form -->
			 <center>         
		            <form action='updatekalab1.php'  method='POST' >
		               <table>
		                  <tr>
		                    <td> Username</td>
						  ...
						  <tr>
						  <td><a href="kalab.php"><button type="submit" name="id" class="btn btn-warning icon-edit" > Update</button></a></td>
						  </tr>
		            </table>
