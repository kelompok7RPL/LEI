	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
				<i class="icon-edit"></i>
				<a href="#">Update Data Aslab</a></li>
			</ul>
			
			<center>
				<H1> Update Data Aslab</H1>
				</center><br>
			<!-- form -->
			 <center>         
		            <form action='updateaslab1.php'  method='POST' >
		               <table>
		                  <tr>
		                    <td> Username</td>
						  ...
						  <tr>
						  <td><a href="aslab.php"><button type="submit" name="id" class="btn btn-warning icon-edit" > Update</button></a></td>
						  </tr>
